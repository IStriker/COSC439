...
void check_options(ServerMessage *send_message, ClientMessage *recieve_message){
    ...
    } else if(recieve_message->request_type == LoggedIn){				/* if logged in */
	...
	} else if(recieve_message->request_type == Receive){
		
		/* this feature does not exist */
		return;
	} else if(recieve_message->request_type == Search){
		
		/* this feature does not exist */
		return;
	} else if(recieve_message->request_type = Unfollow){
		
		/* this feature does not exist */
		return;
 		
	} else if(recieve_message->request_type == Logout){
		return;
	}
